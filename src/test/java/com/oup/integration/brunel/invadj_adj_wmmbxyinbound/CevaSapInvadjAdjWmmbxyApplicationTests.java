...
import com.oup.integration.brunel.invadj_adj_wmmbxyinbound.routes.CevainvadjAdjToSapWmmbxyRoute;
...
public class CevaSapInvadjAdjWmmbxyApplicationTests {
	...
	public void setup() throws Exception {
		camelContext.getRouteDefinition(CevainvadjAdjToSapWmmbxyRoute.class.getSimpleName()).adviceWith(camelContext,
